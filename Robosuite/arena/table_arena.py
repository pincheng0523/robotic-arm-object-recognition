...
class TableArena(Arena):
    ...
    def __init__(
        ...
        xml_files = [
            "arenas/table_arena1.xml",
            "arenas/table_arena2.xml",
            "arenas/table_arena3.xml",
            "arenas/table_arena4.xml",
            "arenas/table_arena5.xml",
            "arenas/table_arena6.xml",
            "arenas/table_arena7.xml",
            "arenas/table_arena8.xml",
            "arenas/table_arena9.xml",
            
            "arenas/table_arena1-1.xml",
            "arenas/table_arena2-1.xml",
            "arenas/table_arena3-1.xml",
            "arenas/table_arena4-1.xml",
            "arenas/table_arena5-1.xml",
            "arenas/table_arena6-1.xml",
            "arenas/table_arena7-1.xml",
            "arenas/table_arena8-1.xml",
            "arenas/table_arena9-1.xml",
        
            "arenas/table_arena1-3.xml",
            "arenas/table_arena2-3.xml",
            "arenas/table_arena3-3.xml",
            "arenas/table_arena4-3.xml",
            "arenas/table_arena5-3.xml",
            "arenas/table_arena6-3.xml",
            "arenas/table_arena7-3.xml",
            "arenas/table_arena8-3.xml",
            "arenas/table_arena9-3.xml"

            # 可以添加更多的選項
        ]
        # 隨機選擇一個XML文件
        if xml is None:
            xml = random.choice(xml_files)

        self.xml_file = xml  # 保存XML文件名称
